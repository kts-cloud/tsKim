...
//    procedure parse_FLDR;
    ...
    procedure parse_EODS(nCH : Integer);
...
{$IFDEF WIN64}
    ...
    procedure ReadMsgEas64(sMessage: PAnsiChar);
...
procedure TGmes.parse_EODS(nCH : Integer);
begin
  MesData[nCH].MesSentMsg := MES_UNKNOWN; // JHHWANG-GMES 2018-06-27
  SendR2REods(nCH);
end;
...
procedure TGmes.ReadMsgEas64(sMessage: PAnsiChar);
var
  sMsg, sMode   : string;
  sDebug  : string;
  nCh     : Integer;
...
//  GuiData    : RSyncHost;
//begin
//  GuiData.MsgType := MSG_TYPE_HOST;
//  GuiData.Channel	:= nCH;
//  GuiData.MsgMode := nGuiMode;
//  GuiData.bError  := nParam <> 0;
//  GuiData.Msg     := sMsg;
//  ccd.dwData      := 0;
...
{$IFDEF WIN32}
    ...
    if bIsChMsg then begin
      ...
      case nMsgType of           SendTestGuiDisplay
